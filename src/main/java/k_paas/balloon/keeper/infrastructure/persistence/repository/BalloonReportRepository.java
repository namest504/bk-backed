...
public interface BalloonReportRepository extends JpaRepository<BalloonReport, Long> {
    ...
    @Query("""
            select new k_paas.balloon.keeper.application.domain.balloon.dto.BalloonReportWithCount(br.centerLatitude, br.centerLongitude, br.streetAddress, count(br.id))
